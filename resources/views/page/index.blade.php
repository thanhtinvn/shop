							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="product.html"><img src="image/product/{{ $new->image }}" alt="" height="250px" width="auto"></a>
									</div>
					...
					<div class="beta-products-list">
						...
						@foreach($promotionProduct as $promotion)
							<div class="col-sm-3">
								<div class="single-item">
									<div class="single-item-header">
										<a href="product.html"><img src="image/product/{{ $promotion->image }}" alt="" height="250px" width="auto">></a>
									</div>
									<div class="single-item-body">
						...
						<div class="row">{{ $promotionProduct->links() }}</div>
					</div> <!-- .beta-products-list -->
				</div>
